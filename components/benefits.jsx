      ...
      <Container>
        ...
        <div className="w-full sm:w-[80%] flex mx-auto flex-col items-center sm:px-4">
          <div className="pt-10 sm:pt-20 flex flex-col items-center w-full">
            <div className="border border-neutral-800 p-5 md:p-10 w-full">
              ...
              <p className="text-sm sm:text-base md:text-[17px] text-[#C5C5C5] w-full leading-tight">
          ...
          <div className="pt-5 flex flex-col items-center w-full">
            <div className="border border-neutral-800 p-5 md:p-10 w-full">
              ...
              <p className="text-sm sm:text-base md:text-[17px] text-[#C5C5C5] tracking-tight w-full leading-tight">
          ...
          <div className="w-full flex items-center justify-center my-12">
            <Button className="flex justify-center tracking-widest items-center w-[90%] sm:w-fit text-paraMobile uppercase font-semibold">
              book a free call
